  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-between p-36">
      ...
      <div className="mb-32 grid text-center lg:max-w-5xl lg:w-full lg:mb-0 lg:grid-cols-4 lg:text-left">
        ...
        <div className="places-div">Punjab</div>
        <div className="places-div">Vancouver</div>
        <div className="places-div">Paris</div>
        <div className="places-div">Budapest</div>
        <div className="places-div">Rome</div>
        <div className="places-div">New York</div>
      </div>
    </main>
  );
}
